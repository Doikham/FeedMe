...
class ListRestaurant : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list.adapter = restaurantArrayAdapter
        list.setOnItemClickListener { adapterView, view, position, ->
    ...
    private class RestaurantArrayAdapter(var context: Context, var resource: Int, var objects: ArrayList<Restaurant>) : BaseAdapter(){
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            if (convertView==null){
                ...
                val viewHolder = RecyclerView.ViewHolder(view.resListImg, view.ResListName, view.resListDes)
                view.tag = viewHolder
            } else{
                view = convertView
            }
